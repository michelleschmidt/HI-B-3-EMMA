...
//MAP.PHP
    $(document).ready(function() {
        ...
        if(location.farbe != "009900"){
            ...
            if(location.farbe == "CC0000"){
                var marker = L.marker([location.latitude, location.longitude], {icon: redIcon}).addTo(map)
            }   
            else{marker = L.marker([location.latitude, location.longitude], {icon: yelllowIcon}).addTo(map)}
        }else{marker = L.marker([location.latitude, location.longitude], {icon: greenIcon}).addTo(map)}
